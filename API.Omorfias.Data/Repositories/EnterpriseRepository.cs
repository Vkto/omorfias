    ...
    public class EnterpriseRepository : IEnterpriseRepository
    {
        ...
        public Enterprise GetEnterprise(int id)
        {
            var enterprises = new List<Enterprise>
            {
                ...
                new Enterprise{Adress = new Adress{ City ="Belo Horizonte", Id   = 2,Neighborhood="Pampulha", Number= 921, Street ="Av. Cel. José Dias Bicalho", Telephone = 31995854725},AverageValue = 3,Category= Enumerator.CategoryEnum.BeautyStudio, UrlImage= "https://omorfias.s3-sa-east-1.amazonaws.com/Salao+2.jpg", Cnpj = 58284242000134, Description="Salão e barbearia especializada em cortes de cabelo masculio e feminino, e fornecemos serviços de estética em geral!", Evaluation = 4, Id=2, Name="Dom Beleza E Estética", Telephone = 3136521452, ServiceLocation = new ServiceLocation{Id =2, Home =true,Store=true },ReviewsNumber=33},


                new Enterprise{Adress = new Adress{ City ="Belo Horizonte", Id   = 3,Neighborhood="Santo Antônio", Number= 82, Street ="R. Barão de Macaúbas", Telephone = 31995854725},AverageValue = 5,Category= Enumerator.CategoryEnum.BarberShop, UrlImage= "https://omorfias.s3-sa-east-1.amazonaws.com/Salao+3.jpg?versionId=rhKEBhz9jcbWGZbc022kCfcUjhV2EY2U", Cnpj = 58284242000134, Description="Salão de cabeleireiros especializados em tingimentos e design de sobrancelha, venha fazer seu dia da noiva conosco!", Evaluation = 4, Id=2, Name="Studio WL - Salão de Beleza", Telephone = 3136521452, ServiceLocation = new ServiceLocation{Id =2, Home =true,Store=true },ReviewsNumber=74},
            };
